...
while True:
    ...
    if juego.pantalla_actual == "jardin":
        ...
        texto1 = fuente.render(juego.letras[0], True, (0,0,0))
        pantalla.blit(texto1, (493,290))
        texto2 = fuente.render(juego.letras[1], True, (0,0,0))
        pantalla.blit(texto2, (607,290))
        texto3 = fuente.render(juego.letras[2], True, (0,0,0))
        pantalla.blit(texto3, (723,290))
        texto4 = fuente.render(juego.letras[3], True, (0,0,0))
