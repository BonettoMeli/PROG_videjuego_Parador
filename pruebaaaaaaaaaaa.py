...
Boton_bolso = pygame.Rect(1210, 610, 150, 130)

casilla1 = pygame.Rect(520, 640, 60, 60)
casilla2 = pygame.Rect(590, 640, 60, 60)
casilla3 = pygame.Rect(655, 640, 60, 60)
casilla4 = pygame.Rect(720, 640, 60, 60)
casilla5 = pygame.Rect(790, 640, 60, 60)
casilla6 = pygame.Rect(860, 640, 60, 60)
...
B_libro_atras = pygame.Rect(1200, 660, 120, 100)
...
charla6_sonido = pygame.mixer.Sound("musica_sonido/12_que_raro_el_tren.mpeg")
charla7_sonido = pygame.mixer.Sound("musica_sonido/13_rapido_ve_a_preguntarle.mpeg")
charla8_sonido = pygame.mixer.Sound("musica_sonido/14_y_cada_una_es_unica.mpeg")
charla9_sonido = pygame.mixer.Sound("musica_sonido/15_el_maquinista_me_dijo.mpeg")
#charla10_sonido = pygame.mixer.Sound("musica_sonido/
#charla11_sonido = pygame.mixer.Sound("musica_sonido/
#charla12_sonido = pygame.mixer.Sound("musica_sonido/
#charla13_sonido = pygame.mixer.Sound("musica_sonido/
#charla14_sonido = pygame.mixer.Sound("musica_sonido/
#charla15_sonido = pygame.mixer.Sound("musica_sonido/
...
#charla12_son_reproduciendo = False
#charla13_son_reproduciendo = False
#charla14_son_reproduciendo = False
#charla15_son_reproduciendo = False
favela_reproduciendo = False

favela = pygame.mixer.Sound("musica_sonido/Favela.mp3")
favela.set_volume(0.5)
...
charlas_lista = ["charla1", "charla2", "charla3", "charla4", "charla5",
                     "charla6", "charla7", "charla8", "charla9"]
...
while True:
    for evento in pygame.event.get():
        ...
        if evento.type == pygame.MOUSEBUTTONDOWN:
            ...
            if pantalla_actual == "inicio": # BOTÓN DEL MENÚ PRINCIPAL
                ...
                if flecha_abajo_derecha.collidepoint(evento.pos):
            ...
            #-----------------------------nivel 1-------------------------------------------------------
                ...
                elif flecha_centro_central.collidepoint(evento.pos):
                    pantalla_actual = "cofre_zoom"
                ...
                if flecha_cabina2.collidepoint(evento.pos):
                    pantalla_actual = "cofre_abierto"
                    AAA = False
                if flecha_centro_central_peque.collidepoint(evento.pos):
                    pantalla_actual = "cofre_vacio"
                    BBB = False
                ...
                if flecha_cabina.collidepoint(evento.pos):
                    pantalla_actual = "cabina"
            ...
            #------------------------------------------------------------------------------
                ...
                if BCentro_n2.collidepoint(evento.pos):
                    pantalla_actual = "caminos"

                elif B_interior.collidepoint(evento.pos):
                    pantalla_actual = "interior2"

            elif pantalla_actual == "caminos":
                if camino1.collidepoint(evento.pos):
                    pantalla_actual = "libro"
                
                elif atras.collidepoint(evento.pos):
                    pantalla_actual = "archivo"

                elif camino2.collidepoint(evento.pos):
                    pantalla_actual = "puerta_biblioteca"

                elif camino3.collidepoint(evento.pos):
                    pantalla_actual = "casa"

            elif pantalla_actual == "puerta_biblioteca":
                if atras.collidepoint(evento.pos):
                    pantalla_actual = "caminos"

            elif pantalla_actual == "libro":
                if B_libro_atras.collidepoint(evento.pos):
                    pantalla_actual = "caminos"
    ...
    if pantalla_actual == "inicio":
        ...
        if tiempo > 2000:
            pantalla.fill((0, 0, 0))
        if tiempo > 2500:
            for i in range (len(charlas_lista)):
                if charlas_lista[i]=="charla1":
                    pantalla.blit(charla1, (0, 0))
                    pantalla_actual = "charla1"
    ...
    #________________________________________ NIVEL 2 ___________________________________________________
        ...
        flecha_abajo_derecha_f(1250, 700)
